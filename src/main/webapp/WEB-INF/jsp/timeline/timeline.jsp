			...
			<c:forEach items="${postList}" var="post">
				...
				<div class="card border rounded mt-3">
					...
					<div class="card-post m-3">
						<span class="font-weight-bold">글쓴이${post.userId}</span> <span>${post.content}</span>
					</div>
					...
					<div class="card-comment-list m-2">
						...
						<div class="card-comment m-1">
							...
							<%-- 댓글 삭제 버튼 --%>
							<a href="#" class="comment-del-btn"> <img
...
<script>
	$(document).ready(function() {
		...
		$('#writeBtn').on('click', function() {
			...
			formData.append("file", $('#file')[0].files[0]); // $('#file')[0]은 첫번째 input file 태그를 의미, files[0]는 업로드 된 첫번째 파일
			...
			$.ajax({
				...
				url : "/post/create",
				data : formData,
				entype : "multipart/form-data" //파일 업로드를 위한 필수 설정!
				,
